...
const renderCard = (data) => {
    const { user: { name, profile_img }, article: { title, comment_count, reaction_count, publish_date } } = data;
      ...
      <div class="container">
        ...
        <div class="author-info">
          <img
            ...
            alt="${name}"
          />
          <h5>${name} ● ${publish_date}</h5>
        </div>
        <div class="reaction">
          <h5>💬 ${comment_count}</h5>
          <h5><span style="color: red;">❤</span> ${reaction_count}</h5>
        </div>
      </div>
